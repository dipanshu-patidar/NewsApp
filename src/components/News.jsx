...
export default class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=379fbd27d9ee4adcb31cd0b2491cbba4&page=1&pageSize=10`
        this.setState({
            loading: true
        })
    ...
    handleToPrev = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=379fbd27d9ee4adcb31cd0b2491cbba4&page=${this.state.page - 1}&pageSize=10`
        this.setState({
            loading: true
        })
        let data = await fetch(url);
